...
namespace LOCADORA.Controllers
{
    public class PagamentosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("id,dias,valor_final")] Pagamento pagamento)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("id,dias,valor_final")] Pagamento pagamento)
        {
            if (id != pagamento.id)
            {
                return NotFound();
